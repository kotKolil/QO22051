...
@Autonomous(name="Basik Parking by Misha Treska", group="Robot")
@Disabled
public class BasikParking extends LinearOpMode {
...
//
        ...
        right(FORWARD_SPEED, 3000);
        back(FORWARD_SPEED,3000);
        left(FORWARD_SPEED, 3000);
